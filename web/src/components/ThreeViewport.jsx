...
import { Layers, Cpu, Box, Film, Gamepad2 } from 'lucide-react';
...
export default function ThreeViewport({ rigMode = 'cinematic_cache', onPrimSelect, selectedPrim }) {
  ...
  return (
    <div className="relative w-full h-full min-h-[460px] bg-neutral-950 rounded-xl overflow-hidden border border-neutral-800">
      {/* 3D WebGL Canvas */}
